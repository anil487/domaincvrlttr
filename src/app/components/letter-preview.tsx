...
export function LetterPreview({ data, isGenerating }: LetterPreviewProps) {
  return (
    <Print>
      <div className="bg-white  p-4 rounded-lg shadow w-full min-h-[842px]  print:shadow-none print:p-1 print:min-h-0 print:w-auto print:max-w-none relative">
        <div className="space-y-3 lg:space-y-6">
          <div className="text-right">
            <p>Date: {formatDate(new Date())}</p>
          </div>

          <div className=" space-1 mx-1 lg:space-y-2 lg:mx-3">
            <p>To,</p>
            <p>The Hostmaster,</p>
          ...
          {data.purpose.length !== 0 && (
            <div className="absolute right-12  bottom-8 justify-end mt-2 hidden lg:flex print:hidden">
